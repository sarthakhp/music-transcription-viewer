...
class JobListItem {
  ...
  factory JobListItem.fromJson(Map<String, dynamic> json) {
    return JobListItem(
      ...
      // Metrics are null for jobs that never finished (failed/cancelled).
      duration: (json['duration'] as num?)?.toDouble() ?? 0.0,
      tempoBpm: (json['tempo_bpm'] as num?)?.toDouble() ?? 0.0,
      numFrames: json['num_frames'] as int? ?? 0,
      numChords: json['num_chords'] as int? ?? 0,
      sourceType: json['source_type'] as String?,
      sourceUrl: json['source_url'] as String?,
      videoTitle: json['video_title'] as String?,
    );
